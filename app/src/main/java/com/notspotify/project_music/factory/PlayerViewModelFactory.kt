...
class PlayerViewModelFactory(private val apiSong: APISong, private val application: Application,private val songDAO: SongDAO) : ViewModelProvider.NewInstanceFactory() {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return PlayerViewModel(apiSong,application,songDAO) as T
    }
}